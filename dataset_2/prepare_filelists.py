...
def main(speechdiff_dir, csv_path, output_dir):
    ...
    def all_splits(data, output_dir):
        '''
        all model, i.e. multispeaker Grad-TTS model using all speakers. ASp model in the paper.
        '''
        corps = data.corpus.unique()
        blocks = data.block.unique()
        for corp in corps:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", "-o", type=str, default="output", help="Output directory, speechdiff filelists will be saved here") 
