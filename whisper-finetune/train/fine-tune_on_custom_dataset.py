...
'''
evaluate_dir = os.path.join(os.path.dirname(__file__), "..", "evaluate")  # Go up one level to the main directory
...
parser.add_argument(
    ...
    type=str, 
    required=False, 
    default='output_model_dir/log', 
    help='Output directory for the logfiles generated.'
)
