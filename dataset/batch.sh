...
python TTDS.py /mnt/parscratch/users/acr22wl/TTDS/dataset/TORGO --speechdiff_dir /users/acr22wl/TTDS/speech-diff --output_dir /mnt/parscratch/users/acr22wl/TTDS_out/output